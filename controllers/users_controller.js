...
module.exports.update = async function (req, res) {
        ...
        if(req.user.id == req.params.id){
            try{
                ...
                //our form tag won't work here directly because it encypted now 
                //but for that we have multer function uploadedAvatar in which request is present (look in the function diskStorage just above it)
                User.uploadedAvatar(req,res,function(err){
                    ...
                    //if request has file because this is not true that everyone will upload a file everytime
                    if(req.file){
